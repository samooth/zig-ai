...
> Qwen3.5-0.8B-Q4_0.gguf: Pearson 0.9989 en logits del primer token). Fase H completada.
...
Fase H completada. Entregables: capa de atención completa con
...
- [`../README.md`](../README.md) — build, CLI, repo structure
- [`../ROADMAP.md`](../ROADMAP.md) — public roadmap
- [`../CHANGELOG.md`](../CHANGELOG.md) — changelog
- [`airllm-layer-streaming-guide.md`](airllm-layer-streaming-guide.md) — user guide: AirLLM layer streaming
- [This guide in Spanish](qwen35-hybrid-deltanet.es.md)
